...
//       <h2 className="text-xl font-bold mb-4 text-center text-gray-800 dark:text-green-400">Generated Password:</h2>
//       <div className="flex items-center justify-between">
//         <p className="font-mono text-lg bg-gray-100 dark:bg-gray-700 p-3 rounded w-full mr-2 text-gray-800 dark:text-green-400 text-center break-all">{password}</p>
//         <button 
