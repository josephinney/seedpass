...
//       <h2 className="text-xl font-bold mb-6 text-center text-gray-800 dark:text-green-400">Enter your seeds</h2>
...
//           className="w-full px-3 py-2 border rounded-md dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400"
//         />
//       </div>
      
//       <div className="mb-4">
//         <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Favorite Number</label>
//         <input
//           type="number"
//           value={seed2}
...
//       <div className="mb-6">
//         <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Important Year</label>
//         <input
//           type="number"
//           value={seed3}
